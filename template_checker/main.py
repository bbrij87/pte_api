...
# Constants
template_pool_threshold = 0.7
use_template_matching = False
sentence_penalty_value = 0.1
max_score_image_type_and_relationship = 0.15
score_per_match_image_type_and_relationship = 0.05
...
def check_template_pool_similarity(response, template_pool):
    """
...
def compute_template_score(response, image_type, tags, template_phrases, relevant_keywords):
    """
